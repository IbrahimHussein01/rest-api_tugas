...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCXkCLJH7uwNeD44LoaXIDtA&key=AIzaSyDwDL62m_LAMZPb2kBvjOzPVcRos06ujVM');
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Ibrahim</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="display-4">Muhammad Febriyand Ibrahim Hussein</h1>
          <h3 class="lead">Programmer | Youtuber | UI/UX Design</h3>
        </div>
      </div>
    </div>
          ...
          <div class="col md-5">
            <div class="row">
              ...
              <div class="col-md-8 d-flex flex-column justify-content-center">
                ...
                <div class="g-ytsubscribe" data-channelid="UCXkCLJH7uwNeD44LoaXIDtA" data-layout="default" data-count="hidden"></div>
              </div>
            </div>
            <div class="row mt-3 pb-3">
              ...
              <div class="col">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?=$urlViewCountVideoId?>?rel=0" allowfullscreen></iframe>
                </div>
                <h5><?=$urlViewCountVideoIdName?></h5>
              </div>
            </div>
          </div>
        </div>
